  ...
  return (
    <div className='about-container'>
      ...
      <div className='about-text'>
        ...
        Sundays, visiting different breweries with my dear friends, and more. If
        you are curious, my favorite beer is the Double Berry Wheat from Cooper
        River Brewing in beautiful Charleston, South Carolina. I like to think
        of myself as a social butterfly, so please feel free to reach out,
